...
const STRINGS = {
  EN: {
    ...
    filterAll: 'All', filterSEP: 'Syringe exchange', filterNarcan: 'Naloxone', filterTest: 'Test strips', filterWound: 'Wound care',
    hereNow: "I'm here to help, not to judge.",
  ...
  ES: {
    ...
    filterAll: 'Todo', filterSEP: 'Jeringas', filterNarcan: 'Naloxona', filterTest: 'Tiras de prueba', filterWound: 'Heridas',
    hereNow: 'Estoy aquí para ayudar, no para juzgar.',
  ...
  ZH: {
    ...
    filterAll: '全部', filterSEP: '针具交换', filterNarcan: '纳洛酮', filterTest: '检测试纸', filterWound: '伤口护理',
    hereNow: '我在这里帮你，不会评判。',
